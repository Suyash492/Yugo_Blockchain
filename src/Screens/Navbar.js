...
const Navbar = () => {
  ...
  return (
    <nav className="bg-gray-800 flex items-center justify-between flex-wrap px-6 py-4">
    ...
    <div  className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
      <ul className="flex ml-auto">
        <li>
          <NavLink exact to="/Allrides" className="text-white hover:text-gray-200 px-4">
            All ride
          </NavLink>
        </li>
        <li>
        ...
        <li className="relative">
          <button className="text-white hover:text-gray-200 px-4" onClick={() => setShowProfile(!showProfile)}>
            Profile
          </button>
          {showProfile && (
            <ul className="absolute right-0 mt-2 py-2 w-48 bg-white rounded-lg shadow-xl z-10">
              <li>
                <NavLink to="/Yourrides" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">
                  Your Rides
                </NavLink>
              </li>
              <li>
                <NavLink to="/Payments" className="block px-4 py-2 text-gray-800 hover:bg-gray-200">
                  Payments
                </NavLink>
              </li>
              <li>
